...
const listOfBooks = {
    '01': {season: 'Winter', name: 'The Book Eaters', author: 'Sunyi Dean'},
    '02': {season: 'Winter', name: 'Cackle', author: 'Rachel Harrison'},
    '03': {season: 'Winter', name: 'Dante: Poet of the Secular World', author: 'Erich Auerbach'},
    '04': {season: 'Winter', name: 'The Last Queen', author: 'Clive Irving'},
    '05': {season: 'Spring', name: 'The Body', author: 'Stephen King'},
    '06': {season: 'Spring', name: 'Carry: A Memoir of Survival on Stolen Land', author: 'Toni Jenson'},
    '07': {season: 'Spring', name: 'Days of Distraction', author: 'Alexandra Chang'},
    '08': {season: 'Spring', name: 'Dominicana', author: 'Angie Cruz'},
    '09': {season: 'Summer', name: 'Crude: A Memoir', author: 'Pablo Fajardo & ​​Sophie Tardy-Joubert'},
    '10': {season: 'Summer', name: 'Let My People Go Surfing', author: 'Yvon Chouinard'},
    '11': {season: 'Summer', name: 'The Octopus Museum: Poems', author: 'Brenda Shaughnessy'},
    '12': {season: 'Summer', name: 'Shark Dialogues: A Novel', author: 'Kiana Davenport'},
    '13': {season: 'Autumn', name: 'Casual Conversation', author: 'Renia White'},
    '14': {season: 'Autumn', name: 'The Great Fire', author: 'Lou Ureneck'},
    '15': {season: 'Autumn', name: 'Rickey: The Life and Legend', author: 'Howard Bryant'},
    '16': {season: 'Autumn', name: 'Slug: And Other Stories', author: 'Megan Milks'},
};
...
function getEmptyUser() {
    let emptyUser = {
        ...
        bankCardExpirationCode2: '',
        bankCardCVC: '',
        bankCardCardholderName: '',
        bankCardPoastlCode: '',
        bankCardCity: '',
    }
    return emptyUser;
